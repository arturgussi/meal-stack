...
class CreateRestaurantUseCaseTest {
    ...
    void shouldCreateRestaurantSuccessfully() {
        Long ownerId = 1L;
        Restaurant restaurantToCreate = new Restaurant(null, "Tech Burger", "Fast Food", "08:00-22:00", "Rua A", 123, "SP", "01000000", ownerId);
        
        User owner = new User();
        owner.setId(ownerId);
        owner.setUserType(UserType.DONO_RESTAURANTE);

        Restaurant createdRestaurant = new Restaurant(10L, "Tech Burger", "Fast Food", "08:00-22:00", "Rua A", 123, "SP", "01000000", ownerId, LocalDateTime.now(), LocalDateTime.now());
    ...
    void shouldThrowBusinessRuleExceptionWhenRestaurantNameAlreadyExists() {
        ...
        assertThat(exception.getMessage()).contains("Já existe um restaurante cadastrado com o nome: " + restaurantToCreate.getName());
